 ...
 */
export function getMemoryBaseDir(caller, scope) {
    switch (scope) {
        case 'user':
 ...
 */
export function getMemoryFilePath(caller, scope) {
 ...
 */
export function getMemoryArchiveDir(caller, scope) {
    const baseDir = getMemoryBaseDir(caller, scope);
    if (scope === 'user') {
 ...
 */
export function resolveArchivePath(caller, scope, relativePath) {
