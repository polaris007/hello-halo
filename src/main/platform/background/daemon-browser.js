...
export class DaemonBrowserManager {
     ...
     */
    async getDaemonBrowserWindow(url) {
     ...
     */
    async prepareWindow(url, partition) {
    ...
    startReleaseTimer() {
        ...
        this.releaseTimer = setTimeout(() => {
            if (this.isInUse) {
                console.warn(`[DaemonBrowser] Auto-releasing after ${AUTO_RELEASE_TIMEOUT_MS / 1000}s timeout`);
...
//# sourceMappingURL=daemon-browser.js.map