 ...
 */
export { initRegistryService, shutdownRegistryService, 
// Re-export key functions for controller use
refreshIndex, listApps, getAppDetail, installFromStore, checkUpdates, getRegistries, addRegistry, removeRegistry, toggleRegistry, } from './registry.service';
