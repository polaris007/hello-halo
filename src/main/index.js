...
const gotTheLock = !app.isPackaged || process.env.HALO_E2E_TEST ? true : app.requestSingleInstanceLock();
if (!gotTheLock) {
...
import { initializeEssentialServices, initializeExtendedServices, cleanupExtendedServices } from './bootstrap';
...
async function shutdownServicesWithTimeout(timeoutMs) {
