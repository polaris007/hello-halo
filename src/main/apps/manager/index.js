...
export { AppNotFoundError, AppAlreadyInstalledError, InvalidStatusTransitionError, SpaceNotFoundError, } from './errors';
// ============================================
// Module State
// ============================================
 ...
 */
export async function initAppManager(deps) {
 ...
 */
export async function shutdownAppManager() {
