...
import { listArtifacts, listArtifactsTree, loadTreeChildren, readArtifactContent, saveArtifactContent, detectFileType } from '../../services/artifact.service';
...
function validateFilePath(res, filePath) {
    if (!filePath) {
 ...
 */
export function registerApiRoutes(app, mainWindow) {
    // ===== Config Routes =====
    ...
    app.post('/api/ai-sources/switch-source', async (req, res) => {
        try {
    ...
    app.post('/api/ai-sources/set-model', async (req, res) => {
        try {
    ...
    app.post('/api/ai-sources/sources', async (req, res) => {
        try {
            const manager = getAISourceManager();
    ...
    app.put('/api/ai-sources/sources/:sourceId', async (req, res) => {
        try {
            const manager = getAISourceManager();
    ...
    app.delete('/api/ai-sources/sources/:sourceId', async (req, res) => {
        try {
            const manager = getAISourceManager();
    ...
    // ===== Conversation Routes =====
    app.get('/api/spaces/:spaceId/conversations', async (req, res) => {
        const result = conversationController.listConversations(req.params.spaceId);
        res.json(result);
    });
    app.post('/api/spaces/:spaceId/conversations', async (req, res) => {
        const { title } = req.body;
        const result = conversationController.createConversation(req.params.spaceId, title);
        res.json(result);
    });
    app.get('/api/spaces/:spaceId/conversations/:conversationId', async (req, res) => {
        const result = conversationController.getConversation(req.params.spaceId, req.params.conversationId);
        res.json(result);
    });
    app.put('/api/spaces/:spaceId/conversations/:conversationId', async (req, res) => {
        const result = conversationController.updateConversation(req.params.spaceId, req.params.conversationId, req.body);
        res.json(result);
    });
    app.delete('/api/spaces/:spaceId/conversations/:conversationId', async (req, res) => {
        const result = conversationController.deleteConversation(req.params.spaceId, req.params.conversationId);
        res.json(result);
    });
    app.post('/api/spaces/:spaceId/conversations/:conversationId/messages', async (req, res) => {
        const result = conversationController.addMessage(req.params.spaceId, req.params.conversationId, req.body);
        res.json(result);
    });
    app.put('/api/spaces/:spaceId/conversations/:conversationId/messages/last', async (req, res) => {
        const result = conversationController.updateLastMessage(req.params.spaceId, req.params.conversationId, req.body);
        res.json(result);
    });
    app.get('/api/spaces/:spaceId/conversations/:conversationId/messages/:messageId/thoughts', async (req, res) => {
        const result = conversationController.getMessageThoughts(req.params.spaceId, req.params.conversationId, req.params.messageId);
        res.json(result);
    });
    // Toggle starred status
    app.post('/api/spaces/:spaceId/conversations/:conversationId/star', async (req, res) => {
        const { starred } = req.body;
        const result = conversationController.toggleStarConversation(req.params.spaceId, req.params.conversationId, starred);
        res.json(result);
    });
    // ===== Agent Routes =====
    ...
    app.get('/api/spaces/:spaceId/artifacts/tree', async (req, res) => {
        try {
    ...
    app.post('/api/spaces/:spaceId/artifacts/children', async (req, res) => {
        try {
    ...
    app.get('/api/artifacts/download', async (req, res) => {
        try {
            const validatedPath = validateFilePath(res, req.query.path);
            if (!validatedPath) {
                return;
            }
    ...
    app.get('/api/spaces/:spaceId/artifacts/download-all', async (req, res) => {
        try {
    ...
    app.get('/api/artifacts/detect-type', async (req, res) => {
        try {
            const validatedPath = validateFilePath(res, req.query.path);
            if (!validatedPath)
                return;
    ...
    app.post('/api/notify-channels/test', async (req, res) => {
        try {
            ...
            const result = await testChannel(channelType, channelsConfig);
            res.json({ success: true, data: result });
        }
        catch (error) {
            res.json({ success: false, error: error.message });
    ...
    app.post('/api/notify-channels/clear-cache', async (req, res) => {
        try {
            clearAllTokenCaches();
            res.json({ success: true });
        }
    ...
    app.post('/api/apps/install', async (req, res) => {
        try {
            ...
            const runtime = getAppRuntime();
            if (runtime && spec.type === 'automation') {
                await runtime.activate(appId).catch((err) => {
    ...
    app.post('/api/apps/:appId/reinstall', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.delete('/api/apps/:appId/permanent', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.post('/api/apps/:appId/pause', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.post('/api/apps/:appId/resume', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.post('/api/apps/:appId/trigger', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.get('/api/apps/:appId/activity', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
            ...
            if (req.query.before)
                options.since = Number(req.query.before);
    ...
    app.post('/api/apps/:appId/escalation/:entryId/respond', async (req, res) => {
        try {
    ...
    app.get('/api/apps/:appId/runs/:runId/session', async (req, res) => {
        try {
    ...
    app.post('/api/apps/:appId/config', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.post('/api/apps/:appId/frequency', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.patch('/api/apps/:appId/spec', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.get('/api/apps/:appId/state', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.get('/api/apps/:appId/export-spec', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.post('/api/apps/import-spec', async (req, res) => {
        try {
            const { spaceId, yamlContent, userConfig } = req.body;
            if (!spaceId || typeof spaceId !== 'string') {
    ...
    app.post('/api/apps/:appId/chat/send', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
            ...
            if (!runtime)
                return;
            const request = { ...req.body, appId };
            sendAppChatMessage(getMainWindow(), request).catch((error) => {
                const err = error;
    ...
    app.post('/api/apps/:appId/chat/stop', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.get('/api/apps/:appId/chat/status', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.get('/api/apps/:appId/chat/messages', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.get('/api/apps/:appId/chat/session-state', async (req, res) => {
        try {
            const { appId } = req.params;
            if (!appId) {
                res.status(400).json({ success: false, error: 'Missing appId' });
    ...
    app.get('/api/store/apps/:slug', async (req, res) => {
        try {
    ...
    app.post('/api/store/install', async (req, res) => {
        try {
            const { slug, spaceId, userConfig } = req.body;
    ...
    app.post('/api/store/apps/:slug/install', async (req, res) => {
        try {
    ...
    app.post('/api/store/refresh', async (req, res) => {
        try {
    ...
    app.get('/api/store/updates', async (req, res) => {
        try {
    ...
    app.get('/api/store/registries', async (req, res) => {
        try {
    ...
    app.post('/api/store/registries', async (req, res) => {
        try {
    ...
    app.delete('/api/store/registries/:registryId', async (req, res) => {
        try {
    ...
    app.post('/api/store/registries/:registryId/toggle', async (req, res) => {
        try {
