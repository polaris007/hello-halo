 ...
 */
// Request converters
export { convertAnthropicToOpenAIChat, convertRequestToChat } from './request/anthropic-to-openai-chat';
export { convertAnthropicToOpenAIResponses, convertRequestToResponses } from './request/anthropic-to-openai-responses';
// Response converters
export { convertOpenAIChatToAnthropic, convertChatResponseToAnthropic, createAnthropicErrorResponse, mapFinishReasonToStopReason } from './response/openai-chat-to-anthropic';
export { convertOpenAIResponsesToAnthropic, convertResponsesResponseToAnthropic, mapStatusToStopReason } from './response/openai-responses-to-anthropic';
 ...
 */
export function convertAnthropicToOpenAI(request) {
    return convertAnthropicToOpenAIChat(request).request;
}
/**
 * @deprecated Use convertOpenAIChatToAnthropic instead
 */
export function convertOpenAIToAnthropic(response, requestModel) {
