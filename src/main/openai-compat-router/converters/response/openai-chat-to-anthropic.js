 ...
 */
import { openAIChatToolCallToAnthropicToolUse, openAIChatTextToAnthropicText } from '../content-blocks';
 ...
 */
export function createAnthropicErrorResponse(message) {
    return {
 ...
 */
export function convertOpenAIChatToAnthropic(openaiResponse, requestModel) {
    if (!openaiResponse) {
...
//# sourceMappingURL=openai-chat-to-anthropic.js.map