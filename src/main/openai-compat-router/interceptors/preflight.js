 ...
 */
function getSystemText(request) {
 ...
 */
function matchFingerprint(request) {
 ...
 */
function sendMockAnthropicResponse(context, responseText) {
 ...
 */
export const preflightInterceptor = {
    name: 'preflight',
