...
import { showRecoveryDialog, showFactoryResetDialog, showRecoverySuccessDialog, showRecoveryFailedDialog, isDialogSuppressed } from './ui';
 ...
 */
export async function requestRecoveryConsent(suggestedStrategy, errorMessage) {
 ...
 */
export async function executeRecovery(strategyId, userConsented = false) {
 ...
 * @returns Recovery result
 */
export async function executeRecoveryWithUI(strategyId, errorMessage) {
    const strategy = getStrategy(strategyId);
