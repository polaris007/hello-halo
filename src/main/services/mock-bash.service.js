 ...
 */
export function createMockBash() {
 ...
 */
export function isMockBashMode() {
 ...
 */
export function getMockBashErrorMessage() {
...
//# sourceMappingURL=mock-bash.service.js.map