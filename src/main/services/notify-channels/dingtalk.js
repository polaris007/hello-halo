 ...
 */
export async function sendDingtalk(config, payload) {
 ...
 */
async function sendWorkNotification(config, payload) {
    const channel = 'dingtalk';
 ...
 */
async function sendToGroupChat(config, payload) {
    const channel = 'dingtalk';
 ...
 */
export async function testDingtalk(config) {
    try {
        const manager = getTokenManager(config);
        manager.invalidate();
