...
class BrowserViewManager {
    ...
    stateChangeDebounceTimers = new Map();
    static STATE_CHANGE_DEBOUNCE_MS = 50; // 50ms debounce
    /**
     ...
     */
    async create(viewId, url, options) {
     ...
     */
    emitStateChangeImmediate(viewId) {
...
//# sourceMappingURL=browser-view.service.js.map