 ...
 */
export function formatCanvasContext(canvasContext) {
 ...
 */
export function parseSDKMessage(message, displayModel) {
 ...
 */
export function extractSingleUsage(assistantMsg) {
 ...
 */
export function extractResultUsage(resultMsg, lastSingleUsage) {
